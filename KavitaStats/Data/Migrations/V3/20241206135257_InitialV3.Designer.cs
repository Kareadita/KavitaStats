...
namespace KavitaStats.Data.Migrations.V3
{
    ...
    [Migration("20241206135257_InitialV3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KavitaStats.Entities.V3.LibraryStatFileTypeGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("LibraryStatFileTypeGroup");
                });
            ...
            modelBuilder.Entity("KavitaStats.Entities.V3.UserStatDevicePlatform", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("UserStatDevicePlatform");
                });

            modelBuilder.Entity("KavitaStats.Entities.V3.UserStatRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KavitaStats.Entities.V3.LibraryStatFileTypeGroup", b =>
                {
                    b.HasOne("KavitaStats.Entities.V3.LibraryStat", "LibraryStat")
                        .WithMany("FileTypes")
                        .HasForeignKey("LibraryStatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LibraryStat");
                });
